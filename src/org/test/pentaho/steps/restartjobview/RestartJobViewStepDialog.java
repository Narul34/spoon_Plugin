...
public class RestartJobViewStepDialog extends BaseStepDialog implements StepDialogInterface {


	private static Class<?> PKG = RestartJobViewStepMeta.class;

	private RestartJobViewStepMeta meta;
	...
	public RestartJobViewStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (RestartJobViewStepMeta) in;
	}
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "RestartJobView.Shell.Title")); 
	...
	public void init() {
		...
		initGroup();
		initTable(sourceTable, columnSrc, "RestartJobView.SourceList.Title", 5);
		initCommand();
		initTable(calcTable, columnCalc, "RestartJobView.CalcList.Title", 0);
