...
public class KettleServiceStep extends BaseStep implements StepInterface {
	 ...
	 */
	public KettleServiceStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		KettleServiceStepMeta meta = (KettleServiceStepMeta) smi;
		KettleServiceStepData data = (KettleServiceStepData) sdi;
