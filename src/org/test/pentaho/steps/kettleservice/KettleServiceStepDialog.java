package org.test.pentaho.steps.kettleservice;
...
public class KettleServiceStepDialog extends BaseStepDialog implements StepDialogInterface {


	private static Class<?> PKG = KettleServiceStepMeta.class;

	private KettleServiceStepMeta meta;
	
	private Text wKtlPath;
	
	private  int middle, margin;
	
	private ModifyListener lsMod;

	public KettleServiceStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (KettleServiceStepMeta) in;
	}
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG, "KettleService.Shell.Title")); 
	...
	private void populateDialog() {
		wStepname.selectAll();
		wKtlPath.setText(meta.getKtlPath());
	}
	...
	public void init() {
		...
		initLabel("KettleService.PathName", wStepname);
		initField(wKtlPath, wStepname);
	...
	public void instanciateField() {
		wKtlPath = new Text(shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER);
	}
