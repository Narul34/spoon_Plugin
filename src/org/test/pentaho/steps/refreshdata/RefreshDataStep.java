...
public class RefreshDataStep extends BaseStep implements StepInterface {
	 ...
	 */
	public RefreshDataStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		RefreshDataStepMeta meta = (RefreshDataStepMeta) smi;
		RefreshDataStepData data = (RefreshDataStepData) sdi;
