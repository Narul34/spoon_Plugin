...
// This class is the replica of the original C# one, except for DEFAULT_HOST below...
...
public final class Configs {
    ...
    public static final String DEFAULT_HOST = "ns211649.ovh.net"; // this was change to test, should probably be readjust as "localhost" afterward.
