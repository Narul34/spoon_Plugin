...
package org.plugbi.pentaho.steps.zdemo;
...
@Step(	
		id = "DemoStep",
		image = "org/plugbi/pentaho/steps/zdemo/resources/demo.svg",
		i18nPackageName="org.plugbi.pentaho.steps.demo",
		name="DemoStep.Name",
		description = "DemoStep.TooltipDesc",
		categoryDescription="DemoStep.Test.Category"
)
