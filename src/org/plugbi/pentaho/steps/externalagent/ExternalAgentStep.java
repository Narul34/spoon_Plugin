package org.plugbi.pentaho.steps.externalagent;
...
public class ExternalAgentStep extends BaseStep implements StepInterface {
	 ...
	 */
	public ExternalAgentStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		ExternalAgentStepMeta meta = (ExternalAgentStepMeta) smi;
		ExternalAgentStepData data = (ExternalAgentStepData) sdi;
