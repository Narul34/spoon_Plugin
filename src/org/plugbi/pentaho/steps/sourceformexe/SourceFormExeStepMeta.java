...
@Step(	
		...
		image = "org/plugbi/pentaho/steps/resources/Data-Network.svg",
		i18nPackageName="org.plugbi.pentaho.steps.sourceformexe",
...
public class SourceFormExeStepMeta extends BaseStepMeta implements StepMetaInterface {
	...
	public void setDefault() {
		blockName = BaseMessages.getString(PKG, "SourceFormExe.BlockName.Default");
	}
	...
	public String getXML() throws KettleValueException {
		...
		String xml = XMLHandler.addTagValue("block_name", blockName);
		return xml;
	}
	...
	public void loadXML(Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore) throws KettleXMLException {
		...
		try {
			setBlockName(XMLHandler.getNodeValue(XMLHandler.getSubNode(stepnode, "block_name")));
		} catch (Exception e) {
	...
	{
		try{
			rep.saveStepAttribute(id_transformation, id_step, "block_name", blockName); //$NON-NLS-1$
		}
		catch(Exception e){
	...
	public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases) throws KettleException  {
		try{
			blockName  = rep.getStepAttributeString(id_step, "block_name"); //$NON-NLS-1$
		}
		catch(Exception e){
	...
	public void getFields(RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, StepMeta nextStep, VariableSpace space, Repository repository, IMetaStore metaStore) throws KettleStepException{
		...
		ValueMetaInterface v = new ValueMeta(blockName, ValueMeta.TYPE_STRING);
